    ...
    >
      <div className="flex mx-auto px-4 justify-between items-center py-2">
        ...
        <div className="hidden md:flex items-center space-x-8 ">
          <a href="#" className="text-white font-bold border-b border-transparent hover:border-[#fcbd7d] transition-all duration-300">
            Home
          </a>
          ...
          <a href="#contactUs" className="text-white font-bold border-b border-transparent hover:border-[#fcbd7d] transition-all duration-300">
            Contact
          </a>
        </div>
      </div>
